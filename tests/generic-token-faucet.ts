...
import { GenericTokenFaucet } from "../target/types/generic_token_faucet";
const {
  TOKEN_PROGRAM_ID,
  Token,
...
describe("generic-token-faucet", () => {
  ...
  const program = anchor.workspace
    .GenericTokenFaucet as Program<GenericTokenFaucet>;
  ...
  it("Mint tokens", async () => {
    ...
    const destionationTokenAccount = await getAccount(
      provider.connection,
      destination.address
    );
